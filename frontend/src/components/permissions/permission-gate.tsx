...
export function PermissionGate({ children, fallback = null, permission, anyPermissions, allPermissions }: { children: ReactNode; fallback?: ReactNode; permission?: string; anyPermissions?: readonly string[]; allPermissions?: readonly string[]; }) {
