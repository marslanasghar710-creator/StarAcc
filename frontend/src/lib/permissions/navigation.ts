...
export const navigationItems: NavItem[] = [
  ...
  { title: "Activity Center", href: "/activity", description: "Centralized audit and workflow activity", group: "Administration", icon: Activity, requiredPermissions: ["org.read"] },
