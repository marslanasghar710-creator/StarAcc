  ...
  return <PublicLayout>
    ...
    <section className="mx-auto max-w-6xl px-4 py-14 md:px-6">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        ...
        <Card><CardHeader><CardTitle>Conversion pathways</CardTitle></CardHeader><CardContent className="space-y-3"><Button asChild className="w-full"><TrackedLink href="/register" eventPayload={{ cta: "demo_start_setup" }}>Set up your own company</TrackedLink></Button><Button asChild variant="outline" className="w-full"><TrackedLink href="/contact?intent=demo" eventPayload={{ cta: "demo_book_walkthrough" }}>Book a guided walkthrough</TrackedLink></Button><Button asChild variant="secondary" className="w-full"><TrackedLink href="/login" eventPayload={{ cta: "demo_login" }}>Go to sign in</TrackedLink></Button></CardContent></Card>
      </div>
    </section>
  </PublicLayout>;
}
