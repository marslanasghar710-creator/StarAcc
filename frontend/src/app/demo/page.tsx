  ...
  return <PublicLayout>
    ...
    <section className="mx-auto max-w-6xl px-4 py-14 md:px-6">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        ...
        <Card><CardHeader><CardTitle>Conversion pathways</CardTitle></CardHeader><CardContent className="space-y-3"><Button asChild className="w-full"><TrackedLink href="/register?intent=start_workspace" eventPayload={{ cta_id: "demo_band_start_workspace", cta_label: "Create your own workspace", cta_variant: "primary", source_section: "demo_cta", destination_type: "signup" }} onClick={() => void trackEvent("demo.convert_to_signup.clicked", { demo_session_id: "public-demo", source_surface: "demo_banner", target_route: "/register?intent=start_workspace" }, { page_type: "demo", surface: "demo", funnel_domain: "demo", funnel_stage: "signup_started", is_demo: true })}>Create your own workspace</TrackedLink></Button><Button asChild variant="outline" className="w-full"><TrackedLink href="/contact?intent=demo" eventPayload={{ cta_id: "demo_band_walkthrough", cta_label: "Book a guided walkthrough", cta_variant: "secondary", source_section: "demo_cta", destination_type: "other" }}>Book a guided walkthrough</TrackedLink></Button><Button asChild variant="secondary" className="w-full"><TrackedLink href="/login?redirectTo=/start" eventPayload={{ cta_id: "demo_band_sign_in", cta_label: "Go to sign in", cta_variant: "tertiary", source_section: "demo_cta", destination_type: "other" }}>Go to sign in</TrackedLink></Button></CardContent></Card>
      </div>
    </section>
  </PublicLayout>;
}
