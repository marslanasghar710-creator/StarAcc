  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 md:grid-cols-3 text-sm">
        ...
        <div className="rounded border p-3"><p className="text-muted-foreground">Billing</p><p className="font-semibold">{q.data.billing_status}</p></div>
        ...
        <div className="rounded border p-3"><p className="text-muted-foreground">Unreconciled</p><p className="font-semibold">{q.data.reconciliation_attention.unreconciled_count ?? 0}</p></div>
      </div>
    </div>
  );
}
