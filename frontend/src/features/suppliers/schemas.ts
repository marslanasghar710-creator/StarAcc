...
export const supplierFormSchema = z.object({
  ...
  remittance_address_line1: z.string().trim().max(255).optional().or(z.literal("")),
  remittance_address_line2: z.string().trim().max(255).optional().or(z.literal("")),
  remittance_city: z.string().trim().max(100).optional().or(z.literal("")),
  remittance_state: z.string().trim().max(100).optional().or(z.literal("")),
  remittance_postal_code: z.string().trim().max(20).optional().or(z.literal("")),
  remittance_country: z.string().trim().max(100).optional().or(z.literal("")),
  is_active: z.boolean(),
});
