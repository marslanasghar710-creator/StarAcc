export type InvoiceStatus = "draft" | "approved" | "sent" | "partially_paid" | "paid" | "overdue" | "voided" | "cancelled";
...
export type InvoiceMutationLinePayload = {
  description: string;
  quantity: string;
  unit_price: string;
  account_id: string;
...
export type InvoiceMutationPayload = {
  ...
  notes?: string | null;
  terms?: string | null;
  items: InvoiceMutationLinePayload[];
};

export type InvoiceHeaderUpdatePayload = {
  due_date?: string;
  reference?: string | null;
  customer_po_number?: string | null;
  notes?: string | null;
