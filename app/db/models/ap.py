...
class Bill(Base, UUIDPKMixin, TimestampMixin):
    ...
    status: Mapped[BillStatus] = mapped_column(Enum(BillStatus, name="bill_status", values_callable=lambda enum_cls: [item.value for item in enum_cls]), nullable=False, default=BillStatus.DRAFT)
    bill_type: Mapped[BillType] = mapped_column(Enum(BillType, name="bill_type", values_callable=lambda enum_cls: [item.value for item in enum_cls]), nullable=False, default=BillType.STANDARD)
...
class SupplierCredit(Base, UUIDPKMixin, TimestampMixin):
    ...
    status: Mapped[SupplierCreditStatus] = mapped_column(Enum(SupplierCreditStatus, name="supplier_credit_status", values_callable=lambda enum_cls: [item.value for item in enum_cls]), nullable=False, default=SupplierCreditStatus.DRAFT)
